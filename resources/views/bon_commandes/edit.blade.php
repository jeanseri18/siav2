            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>Modifier le Bon de Commande</h5>
                        <a href="{{ route('bon-commandes.show', $bonCommande) }}" class="btn btn-sm btn-secondary">
                    ...
                    <form action="{{ route('bon-commandes.update', $bonCommande) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                id="notes" name="notes" rows="3">{{ old('notes', $bonCommande->notes) }}</textarea>
                            @error('notes')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <table class="table table-bordered" id="articles_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control ligne_total" 
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="3" id="montant_total">{{ number_format($bonCommande->montant_total, 2) }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
...
$(document).ready(function() {
    ...
    // Calculer les totaux initiaux avec jQuery
    $('.quantite, .prix_unitaire').each(function() {
        calculerLigneTotal(this.closest('tr'));
    });
});
</script>
@endpush
