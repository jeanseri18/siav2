{{-- Page Edit - Modifier le Bon de Commande --}}
@extends('layouts.app')
...
<li class="breadcrumb-item"><a href="{{ route('bon-commandes.show', $bonCommande) }}">{{ $bonCommande->reference }}</a></li>
            ...
            <div class="app-card app-hover-shadow">
                <div class="app-card-header">
                    <h2 class="app-card-title">
                        <i class="fas fa-edit me-2"></i>Modifier le Bon de Commande {{ $bonCommande->reference }}
                    </h2>
                    <div class="app-card-actions">
                        <a href="{{ route('bon-commandes.show', $bonCommande) }}" class="app-btn app-btn-secondary app-btn-sm">
                ...
                <div class="app-card-body">
                    <form action="{{ route('bon-commandes.update', $bonCommande) }}" method="POST" class="app-form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="app-card-body">
                                    ...
                                    <div class="app-form col-6">
                                        <div class="app-form-group">
                                            ...
                                            <input type="date" class="app-form-control @error('date_commande') is-invalid @enderror" 
                                                ...
                                                value="{{ old('date_commande', $bonCommande->date_commande->format('Y-m-d')) }}" required>
                                            @error('date_commande')
                                    ...
                                    <div class="app-form col-6">
                                        <div class="app-form-group">
                                            ...
                                            <input type="date" class="app-form-control @error('date_livraison_prevue') is-invalid @enderror" 
                                                ...
                                                value="{{ old('date_livraison_prevue', $bonCommande->date_livraison_prevue ? $bonCommande->date_livraison_prevue->format('Y-m-d') : '') }}">
                                            ...
                                            <select class="app-form-select @error('demande_approvisionnement_id') is-invalid @enderror" 
                                                ...
                                                @foreach($demandesAppro as $demande)
                                                    <option value="{{ $demande->id }}" 
                                                        {{ old('demande_approvisionnement_id', $bonCommande->demande_approvisionnement_id) == $demande->id ? 'selected' : '' }}>
                                        ...
                                        <div class="app-form-group">
                                            ...
                                            <select class="app-form-select @error('demande_achat_id') is-invalid @enderror" 
                                                ...
                                                @foreach($demandesAchat as $demande)
                                                    <option value="{{ $demande->id }}" 
                                                        {{ old('demande_achat_id', $bonCommande->demande_achat_id) == $demande->id ? 'selected' : '' }}>
                                                        {{ $demande->reference }} ({{ $demande->date_demande->format('d/m/Y') }})
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="app-form-group">
                                    ...
                                    <textarea class="app-form-control @error('notes') is-invalid @enderror" 
                                        id="notes" name="notes" rows="3" placeholder="Notes et commentaires...">{{ old('notes', $bonCommande->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="app-form-control" name="commentaire[]" 
                                                    value="{{ $ligne->commentaire }}" placeholder="Commentaire...">
                                            </td>
                                            <td>
                        ...
                        <div class="app-card-footer">
                            <a href="{{ route('bon-commandes.show', $bonCommande) }}" class="app-btn app-btn-secondary">
