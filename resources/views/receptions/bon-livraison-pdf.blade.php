...
<head>
    <meta charset="UTF-8">
    <title>Bon de livraison fournisseur {{ $bl['numero'] }}</title>
    <style>
...
<table class="header" cellspacing="0" cellpadding="0">
            ...
            <table class="right-block" cellspacing="0" cellpadding="0" align="right" style="width: 205px; margin-left: auto;">
                <tr>
                    <td align="right" style="text-align: right;">
                        <b style="font-size: 16px;">Bon de livraison fournisseur - {{ $bl['numero'] }}</b><br>
    ...
    {{-- Ligne 2 : Société (gauche) | Livré à (droite) — en parallèle --}}
    <tr>
    ...
    <tr>
        <td colspan="2" valign="top" align="left">
            <b>Réf. B.C :</b> {{ $bl['ref_bc'] }}
        </td>
    </tr>

    {{-- B.L émis par (gauche) | Lieu de livraison (droite) --}}
    <tr>
...
<table class="items-table" cellspacing="0" cellpadding="0">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="6">Aucune ligne sur ce bon de livraison fournisseur.</td>
            </tr>
        @endforelse
