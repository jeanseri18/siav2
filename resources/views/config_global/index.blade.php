{{-- Page Index - Liste des Configurations --}}
@extends('layouts.app')

@section('title', 'Gestion des Configurations')
@section('page-title', 'Gestion des Configurations')
                    ...
                    @foreach ($configs as $config)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="app-badge app-badge-light">Aucun logo</span>
                                @endif
                            </td>
                            <td>
                                <div class="app-d-flex app-align-items-center app-gap-2">
                                    ...
                                    <span>{{ $config->businessUnit->nom ?? 'N/A' }}</span>
                                </div>
                            </td>
                            <td>
