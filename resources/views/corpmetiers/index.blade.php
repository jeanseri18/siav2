{{-- Page Index - Liste des Corps de Métier --}}
@extends('layouts.app')

@section('title', 'Gestion des Corps de Métier')
@section('page-title', 'Gestion des Corps de Métier')

@section('breadcrumb')
<li class="breadcrumb-item active">Corps de Métier</li>
@endsection
...
<script>
    $(document).ready(function () {
        ...
        $('.delete-btn').click(function(e) {
            ...
            if (confirm('Voulez-vous vraiment supprimer ce corps de métier ?')) {
