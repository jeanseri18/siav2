...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2>Nouveau calcul de frais généraux</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('frais_generaux.store') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="montant_base">Montant de base</label>
                            <input type="number" step="0.01" min="0" class="form-control" id="montant_base" name="montant_base" value="{{ old('montant_base', $montantSuggere) }}" required>
                            <small class="form-text text-muted">Montant sur lequel les frais généraux seront calculés.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pourcentage">Pourcentage (%)</label>
                            <input type="number" step="0.01" min="0" max="100" class="form-control" id="pourcentage" name="pourcentage" value="{{ old('pourcentage', 10) }}" required>
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <p><strong>Montant de base :</strong> <span id="preview_montant_base">{{ number_format($montantSuggere, 2, ',', ' ') }}</span></p>
                                <p><strong>Pourcentage :</strong> <span id="preview_pourcentage">10</span>%</p>
                                <p><strong>Montant total des frais généraux :</strong> <span id="preview_montant_total">{{ number_format($montantSuggere * 0.10, 2, ',', ' ') }}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
