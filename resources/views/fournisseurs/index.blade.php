...
@section('page-title', 'Liste des Fournisseurs')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="mailto:{{ $fournisseur->email }}" class="app-btn-link">
                        ...
                        <td>
                            ...
                            <a href="tel:{{ $fournisseur->telephone }}" class="app-btn-link">
                                <i class="fas fa-phone-alt me-1"></i>{{ $fournisseur->telephone }}
                            </a>
                            @else
                            -
                            @endif
                        ...
                        <td>
                            <span class="app-badge app-badge-{{ $fournisseur->type == 'Entreprise' ? 'primary' : 'info' }} app-badge-pill">
                                <i class="fas fa-{{ $fournisseur->type == 'Entreprise' ? 'building' : 'user' }} me-1"></i> 
                                {{ $fournisseur->type }}
                            </span>
                        </td>
                        <td>
