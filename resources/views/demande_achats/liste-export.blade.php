...
<head>
    <meta charset="UTF-8">
    <title>{{ $documentTitle ?? 'Liste des demandes d\'achat' }}</title>
    <style>
        body {
...
<table class="header-table">
    <tr>
        ...
        <td>
            <h1>{{ $documentTitle ?? 'Liste des demandes d\'achat' }}</h1>
        </td>
...
<table class="liste">
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="8" class="text-center">Aucune demande d'achat enregistrée</td>
        </tr>
        @endforelse
    </tbody>
</table>
