...
@section('title', 'Modifier une Monnaie')
@section('page-title', 'Modifier une Monnaie')
    ...
    <div class="app-card">
        <div class="app-card-header">
            <h2 class="app-card-title">
                <i class="fas fa-edit me-2"></i>Modifier la Monnaie: {{ $monnaie->nom }}
            </h2>
        </div>
        
        <div class="app-card-body">
            <form action="{{ route('monnaies.update', $monnaie) }}" method="POST" class="app-form">
                @csrf
                @method('PUT')
                ...
                <div class="app-form-row">
                    <div class="app-form-col">
                        <div class="app-form-group">
                            ...
                            <input type="text" name="nom" id="nom" class="app-form-control" value="{{ $monnaie->nom }}" required>
                    ...
                    <div class="app-form-col">
                        <div class="app-form-group">
                            ...
                            <input type="text" name="sigle" id="sigle" class="app-form-control" value="{{ $monnaie->sigle }}" required>
