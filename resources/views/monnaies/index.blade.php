...
@section('page-title', 'Liste des Monnaies')

@section('breadcrumb')
<li class="breadcrumb-item active">Monnaies</li>
@endsection
    ...
    <div class="app-card">
        <div class="app-card-header">
            <h2 class="app-card-title">
                <i class="fas fa-coins me-2"></i>Liste des Monnaies
            </h2>
            <div class="app-card-actions">
                <x-export-pdf-button :route="route('liste.export.pdf', 'monnaies')" />
                <a href="{{ route('monnaies.create') }}" class="app-btn app-btn-primary app-btn-icon">
        ...
        <div class="app-card-body app-table-responsive">
            <table id="currencyTable" class="app-table display">
                <thead>
                    <tr>
                        <th>Nom</th>
                        <th>Sigle</th>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('monnaies.edit', $monnaie) }}">
                                            <i class="fas fa-edit me-2"></i>Modifier
                                        </a>
                                    </li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <form action="{{ route('monnaies.destroy', $monnaie) }}" method="POST" class="delete-form">
                                            @csrf
                                            @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-btn').click(function(e) {
            ...
            if (confirm('Êtes-vous sûr de vouloir supprimer cette monnaie ?')) {
