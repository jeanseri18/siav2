...
@section('title', 'Ajouter un Régime d\'Imposition')
@section('page-title', 'Ajouter un Régime d\'Imposition')
    ...
    <div class="app-card">
        <div class="app-card-header">
            <h2 class="app-card-title">
                <i class="fas fa-balance-scale me-2"></i>Ajouter un Régime d'Imposition
            </h2>
        </div>
        
        <div class="app-card-body">
            <form action="{{ route('regime-impositions.store') }}" method="POST" class="app-form">
                @csrf
                ...
                <div class="app-form-row">
                    ...
                    <div class="app-form-col">
                        <div class="app-form-group">
                            ...
                            <input type="text" name="tva" id="tva" class="app-form-control" required>
