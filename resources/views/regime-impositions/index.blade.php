...
@section('title', 'Liste des Régimes d\'Imposition')
@section('page-title', 'Liste des Régimes d\'Imposition')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('regime-impositions.index') }}">Accueil</a></li>
<li class="breadcrumb-item active">Régimes d'Imposition</li>
@endsection
...
<div class="app-fade-in">
    <div class="app-card">
        ...
        <div class="app-card-body app-table-responsive">
            <table id="regimesTable" class="app-table display">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nom</th>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-btn').click(function(e) {
            ...
            if (confirm('Voulez-vous supprimer ce régime d\'imposition ?')) {
