    ...
    <div class="app-card">
        <div class="app-card-header">
            ...
            <div class="app-card-actions">
                <button type="button" class="app-btn app-btn-primary app-btn-icon" data-bs-toggle="modal" data-bs-target="#transferModal">
                    ...
                    <div class="app-form-row">
                        <div class="app-form-col">
                            <div class="app-form-group">
                                ...
                                <select name="projet_source" id="projet_source" class="app-form-select" required>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Écouter les changements sur les deux sélecteurs
