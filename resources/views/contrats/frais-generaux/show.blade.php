        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Détails du Frais Généraux Parent - {{ $parent->ref }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('contrats.frais-generaux.index', $contrat) }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                                    ...
                                    <p><strong>Référence:</strong> {{ $parent->ref }}</p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tfoot class="bg-light">
                                                <tr>
                                                    <th colspan="4" class="text-right">Total des lignes:</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addLigneModalLabel">Ajouter une ligne de frais généraux</h5>
...
$(document).ready(function() {
    ...
    $('#saveLigneBtn').click(function() {
        ...
        $.ajax({
            url: '{{ route("contrats.frais-generaux.lignes.store", [$contrat, $parent]) }}',
            type: 'POST',
            data: formData,
