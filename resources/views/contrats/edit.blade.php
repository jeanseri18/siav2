                ...
                <div class="app-card-body">
                    ...
                    <form action="{{ route('contrats.update', $contrat->id) }}" method="POST" class="app-form">
                        ...
                        <div class="app-form-group">
                            ...
                            <select class="app-form-select" id="chef_chantier_id" name="chef_chantier_id">
                        ...
                        <div class="app-form-group">
                            ...
                            <input type="number" step="0.01" class="app-form-control" id="montant" name="montant" value="{{ old('montant', $contrat->montant) }}" placeholder="Sera mis à jour après validation du DQE">
