{{-- Modifier un contrat — aligné sur le formulaire projet --}}
@extends('layouts.app')
...
<div class="app-fade-in">
    <div class="app-card shadow-sm border-0">
        ...
        <form action="{{ route('contrats.update', $contrat->id) }}" method="POST" class="app-card-body">
            @csrf
            @method('PUT')
            <input type="hidden" id="projet_id_hidden" name="projet_id_hidden" value="{{ $contrat->id_projet ?? session('projet_id') }}">
            ...
            <div class="alert alert-light border mb-4" role="note">
                ...
                Référence actuelle : <strong>{{ $contrat->ref_contrat }}</strong>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="app-form-control bg-light" id="nom_client"
                                       value="{{ $contrat->client->nom_raison_sociale ?? $contrat->client->prenoms ?? '' }}" readonly tabindex="-1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="delai_paiement" class="app-form-label">Délai de paiement (jours)</label>
                                <input type="text" class="app-form-control bg-light" id="delai_paiement"
                                       value="{{ $contrat->client->delai_paiement ?? '' }}" readonly tabindex="-1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="secteur_activite" class="app-form-label">Secteur d’activité</label>
                                <input type="text" class="app-form-control bg-light" id="secteur_activite"
                                       value="{{ $contrat->client->secteur_activite ?? '' }}" readonly tabindex="-1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="app-card border-start border-4 mb-4 shadow-sm" style="border-color: #033d71 !important;">
                ...
                <div class="app-card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="ref_contrat_display" class="app-form-label">N° contrat</label>
                                <input type="text" class="app-form-control bg-light" id="ref_contrat_display"
                                       value="{{ old('ref_contrat', $contrat->ref_contrat) }}" readonly tabindex="-1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nom_contrat" id="nom_contrat" class="app-form-control @error('nom_contrat') is-invalid @enderror"
                                       value="{{ old('nom_contrat', $contrat->nom_contrat) }}" required>
                                @error('nom_contrat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="date_debut" id="date_debut" class="app-form-control @error('date_debut') is-invalid @enderror"
                                       value="{{ old('date_debut', $contrat->date_debut) }}" required>
                                @error('date_debut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                                ...
                                <select name="chef_chantier_id" id="chef_chantier_id" class="app-form-control @error('chef_chantier_id') is-invalid @enderror">
                                    ...
                                    @foreach ($chefsChantier as $chef)
                                        <option value="{{ $chef->id }}"
                                            ...
                                            {{ old('chef_chantier_id', $contrat->chef_chantier_id) == $chef->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="app-form-control bg-light" id="chef_email"
                                       value="{{ $contrat->chefChantier->email ?? '' }}" readonly tabindex="-1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="chef_telephone" class="app-form-label">Téléphone</label>
                                <input type="text" class="app-form-control bg-light" id="chef_telephone"
                                       value="{{ $contrat->chefChantier->telephone ?? '' }}" readonly tabindex="-1">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="taux_garantie" id="taux_garantie"
                                       ...
                                       value="{{ old('taux_garantie', $contrat->taux_garantie) }}" required>
                                @error('taux_garantie')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="retenue_decennale" id="retenue_decennale" class="app-form-control @error('retenue_decennale') is-invalid @enderror"
                                       value="{{ old('retenue_decennale', $contrat->retenue_decennale ?? 0) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="avance_demarrage" id="avance_demarrage" class="app-form-control @error('avance_demarrage') is-invalid @enderror"
                                       value="{{ old('avance_demarrage', $contrat->avance_demarrage ?? 0) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="montant" id="montant" class="app-form-control @error('montant') is-invalid @enderror"
                                       value="{{ old('montant', $contrat->montant) }}" placeholder="DQE / manuel">
                                @error('montant')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <div class="mb-3 w-100">
                                ...
                                <select class="app-form-control @error('statut') is-invalid @enderror" id="statut" name="statut" required>
                                    <option value="non débuté" {{ old('statut', $contrat->statut) == 'non débuté' ? 'selected' : '' }}>Non débuté</option>
